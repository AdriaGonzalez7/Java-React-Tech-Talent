...
public class JugadoresDAO {
	...
	public void insertarJugador(String nombre, String contraseña) {
		...
		String sqlInsert = "INSERT INTO jugadores (nombre, contraseña, victorias) VALUES (?, 0, ?)";
	...
	public void actualizarVictorias(String nombre) {
		...
		try (Connection conn = connexionDB.conectar(); PreparedStatement stmt = conn.prepareStatement(sql)) {
