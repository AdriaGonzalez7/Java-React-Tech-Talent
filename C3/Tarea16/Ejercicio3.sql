...
SELECT Cajas.Almacen FROM Cajas JOIN Almacen ON Cajas.Almacen = Almacen.codigo GROUP BY Cajas.Almacen HAVING COUNT(*) > (SELECT Capacidad FROM Almacen WHERE codigo = Cajas.Almacen);
...
DELETE FROM Cajas WHERE Almacen IN (SELECT Almacen FROM Cajas GROUP BY Almacen HAVING COUNT(*) > (SELECT Capacidad FROM Almacen WHERE codigo = Cajas.Almacen));
